...
const ThreeWay = ({percentage,link_3,odds3,event_name_3,link_2,odds2,event_name_2,link_1,country,league,icon_image,date,home_team,away_team,event_name,event_name_1,odds1,href_1,href_2,href_3}) => {
    return (
